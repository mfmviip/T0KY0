...
@bot.on(admin_cmd(pattern=f"({BALL_E_MOJI}|سله)( ([1-5])|$)"))
@bot.on(
    sudo_cmd(
        pattern=f"({BALL_E_MOJI}|سله)( ([1-5])|$)",
        allow_sudo=True,
    )
)
async def _(event):
...
@bot.on(admin_cmd(pattern=f"({FOOT_E_MOJI}|طوبه)( ([1-5])|$)"))
@bot.on(
    sudo_cmd(
        pattern=f"({FOOT_E_MOJI}|طوبه)( ([1-5])|$)",
        allow_sudo=True,
    )
)
async def _(event):
...
@bot.on(admin_cmd(pattern=f"({SLOT_E_MOJI}|تخمين)( ([1-64])|$)"))
@bot.on(
    sudo_cmd(
        pattern=f"({SLOT_E_MOJI}|تخمين)( ([1-64])|$)",
        allow_sudo=True,
    )
)
async def _(event):
